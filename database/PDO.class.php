 ...
 */
use App\Database\PDOIterator;
use App\Database\PDOLog;
/** Class DB
...
class DB
{
     ...
     * @param $DBPassword
     */
	public function __construct($Host = DBHost, $DBPort = DBPort, $DBName = DBName, $DBUser = DBUser, $DBPassword = DBPassword)
	{
